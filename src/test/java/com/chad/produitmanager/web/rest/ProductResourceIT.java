...
import com.chad.produitmanager.repository.ProductRepository;
import com.chad.produitmanager.service.dto.ProductDTO;
import com.chad.produitmanager.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).prix(DEFAULT_PRIX);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).prix(UPDATED_PRIX);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPrix()).isEqualByComparingTo(DEFAULT_PRIX);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).prix(UPDATED_PRIX);
        ...
        assertThat(testProduct.getPrix()).isEqualByComparingTo(UPDATED_PRIX);
    }
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).prix(UPDATED_PRIX);

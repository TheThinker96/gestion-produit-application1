...
/**
 * REST controller for managing {@link com.chad.produitmanager.domain.ProductTransaction}.
 */
@RestController
@RequestMapping("/api")
public class ProductTransactionResource {
    ...
    public ResponseEntity<ProductTransactionDTO> createProductTransaction(@Valid @RequestBody ProductTransactionDTO productTransactionDTO)
    ...
    public ResponseEntity<ProductTransactionDTO> updateProductTransaction(
        ...
        @Valid @RequestBody ProductTransactionDTO productTransactionDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<ProductTransactionDTO> partialUpdateProductTransaction(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody ProductTransactionDTO productTransactionDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<ProductTransactionDTO>> getAllProductTransactions(
        ...
        log.debug("REST request to get a page of ProductTransactions");
        Page<ProductTransactionDTO> page = productTransactionService.findAll(pageable);
